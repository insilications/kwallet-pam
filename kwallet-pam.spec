...
Version  : 5.23.90
Release  : 301
URL      : file:///aot/build/clearlinux/packages/kwallet-pam/kwallet-pam-v5.23.90.tar.gz
Source0  : file:///aot/build/clearlinux/packages/kwallet-pam/kwallet-pam-v5.23.90.tar.gz
...
%prep
%setup -q -n kwallet-pam
cd %{_builddir}/kwallet-pam
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1643426154
mkdir -p clr-build
pushd clr-build
