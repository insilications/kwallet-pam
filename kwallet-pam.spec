...
Version  : 5.23.3
Release  : 55
URL      : https://download.kde.org/stable/plasma/5.23.3/kwallet-pam-5.23.3.tar.xz
Source0  : https://download.kde.org/stable/plasma/5.23.3/kwallet-pam-5.23.3.tar.xz
...
%prep
%setup -q -n kwallet-pam-5.23.3
cd %{_builddir}/kwallet-pam-5.23.3
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1636491987
mkdir -p clr-build
pushd clr-build
...
cp %{_builddir}/kwallet-pam-5.23.3/LICENSES/BSD-3-Clause.txt %{buildroot}/usr/share/package-licenses/kwallet-pam/9950d3fdce1cff1f71212fb5abd31453c6ee2f8c
cp %{_builddir}/kwallet-pam-5.23.3/LICENSES/LGPL-2.1-or-later.txt %{buildroot}/usr/share/package-licenses/kwallet-pam/81b58c89ceef8e9f8bd5d00a287edbd15f9d3567
pushd clr-build
%make_install
popd
