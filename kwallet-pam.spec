...
Version  : 5.19.0
Release  : 36
URL      : https://download.kde.org/stable/plasma/5.19.0/kwallet-pam-5.19.0.tar.xz
Source0  : https://download.kde.org/stable/plasma/5.19.0/kwallet-pam-5.19.0.tar.xz
Source1  : https://download.kde.org/stable/plasma/5.19.0/kwallet-pam-5.19.0.tar.xz.sig
...
%prep
%setup -q -n kwallet-pam-5.19.0
cd %{_builddir}/kwallet-pam-5.19.0
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1591732817
mkdir -p clr-build
pushd clr-build
...
cp %{_builddir}/kwallet-pam-5.19.0/COPYING.LIB %{buildroot}/usr/share/package-licenses/kwallet-pam/01a6b4bf79aca9b556822601186afab86e8c4fbf
pushd clr-build
%make_install
popd
