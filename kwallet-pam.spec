...
Source0  : https://download.kde.org/stable/plasma/5.15.4/kwallet-pam-5.15.4.tar.xz
Source99 : https://download.kde.org/stable/plasma/5.15.4/kwallet-pam-5.15.4.tar.xz.sig
...
export LANG=C
export SOURCE_DATE_EPOCH=1554220815
mkdir -p clr-build
pushd clr-build
%cmake ..
make  %{?_smp_mflags}
