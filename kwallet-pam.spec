...
Source0  : https://download.kde.org/stable/plasma/5.16.0/kwallet-pam-5.16.0.tar.xz
Source99 : https://download.kde.org/stable/plasma/5.16.0/kwallet-pam-5.16.0.tar.xz.sig
...
export LANG=C
export SOURCE_DATE_EPOCH=1560269184
mkdir -p clr-build
pushd clr-build
export AR=gcc-ar
