...
Source0  : https://download.kde.org/stable/plasma/5.14.1/kwallet-pam-5.14.1.tar.xz
Source99 : https://download.kde.org/stable/plasma/5.14.1/kwallet-pam-5.14.1.tar.xz.sig
...
export LANG=C
export SOURCE_DATE_EPOCH=1539704035
mkdir -p clr-build
pushd clr-build
%cmake ..
