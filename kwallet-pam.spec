...
Version  : 5.18.0
Release  : 30
URL      : https://download.kde.org/stable/plasma/5.18.0/kwallet-pam-5.18.0.tar.xz
Source0  : https://download.kde.org/stable/plasma/5.18.0/kwallet-pam-5.18.0.tar.xz
Source1  : https://download.kde.org/stable/plasma/5.18.0/kwallet-pam-5.18.0.tar.xz.sig
...
%prep
%setup -q -n kwallet-pam-5.18.0
cd %{_builddir}/kwallet-pam-5.18.0
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1581434702
mkdir -p clr-build
pushd clr-build
...
cp %{_builddir}/kwallet-pam-5.18.0/COPYING.LIB %{buildroot}/usr/share/package-licenses/kwallet-pam/01a6b4bf79aca9b556822601186afab86e8c4fbf
pushd clr-build
%make_install
popd
