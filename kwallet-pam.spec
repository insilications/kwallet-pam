...
Source0  : https://download.kde.org/stable/plasma/5.19.1/kwallet-pam-5.19.1.tar.xz
Source1  : https://download.kde.org/stable/plasma/5.19.1/kwallet-pam-5.19.1.tar.xz.sig
...
%prep
%setup -q -n kwallet-pam-5.19.1
cd %{_builddir}/kwallet-pam-5.19.1
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1592335366
mkdir -p clr-build
pushd clr-build
...
cp %{_builddir}/kwallet-pam-5.19.1/COPYING.LIB %{buildroot}/usr/share/package-licenses/kwallet-pam/01a6b4bf79aca9b556822601186afab86e8c4fbf
pushd clr-build
%make_install
popd
